...
@media (max-width: 64em){
    ...
    background-color: ${props => `rgba(${props.thememtextRgba}, 0.4)`};
    border-radius: 20px;
}
...
const About = () => {
  return (
    ...
    We're fashion studio based in Zootopia. 
We create unique designs that will blow your mind. We also design unique jewellery pieces. 
